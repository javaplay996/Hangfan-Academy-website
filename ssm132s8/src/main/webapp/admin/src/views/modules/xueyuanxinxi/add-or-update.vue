<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学院类型" prop="xueyuanleixing">
          <el-input v-model="ruleForm.xueyuanleixing" 
              placeholder="学院类型" clearable  :readonly="ro.xueyuanleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学院类型" prop="xueyuanleixing">
              <el-input v-model="ruleForm.xueyuanleixing" 
                placeholder="学院类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属地区" prop="suoshudiqu">
          <el-input v-model="ruleForm.suoshudiqu" 
              placeholder="所属地区" clearable  :readonly="ro.suoshudiqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属地区" prop="suoshudiqu">
              <el-input v-model="ruleForm.suoshudiqu" 
                placeholder="所属地区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学院级别" prop="xueyuanjibie">
          <el-input v-model="ruleForm.xueyuanjibie" 
              placeholder="学院级别" clearable  :readonly="ro.xueyuanjibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学院级别" prop="xueyuanjibie">
              <el-input v-model="ruleForm.xueyuanjibie" 
                placeholder="学院级别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="校园风采" prop="xiaoyuanfengcai">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiaoyuanfengcai" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiaoyuanfengcai" label="校园风采" prop="xiaoyuanfengcai">
                    <span v-html="ruleForm.xiaoyuanfengcai"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueyuanmingcheng = true;
          ...
          if(o=='xueyuanleixing'){
            this.ruleForm.xueyuanleixing = obj[o];
	    this.ro.xueyuanleixing = true;
            continue;
          }
          if(o=='suoshudiqu'){
	    ...
	    this.ro.suoshudiqu = true;
          ...
          if(o=='xueyuanjibie'){
            this.ruleForm.xueyuanjibie = obj[o];
	    this.ro.xueyuanjibie = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.youxiang = true;
          ...
          if(o=='xiaoyuanfengcai'){
            this.ruleForm.xiaoyuanfengcai = obj[o];
	    this.ro.xiaoyuanfengcai = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.xiaoyuanfengcai = this.ruleForm.xiaoyuanfengcai.replace(reg,'../../../ssm132s8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
