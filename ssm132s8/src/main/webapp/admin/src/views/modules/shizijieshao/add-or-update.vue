<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教师人数" prop="jiaoshirenshu">
          <el-input v-model="ruleForm.jiaoshirenshu" 
              placeholder="教师人数" clearable  :readonly="ro.jiaoshirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教师人数" prop="jiaoshirenshu">
              <el-input v-model="ruleForm.jiaoshirenshu" 
                placeholder="教师人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="教师风采" prop="jiaoshifengcai">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jiaoshifengcai" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoshifengcai" label="教师风采" prop="jiaoshifengcai">
                    <span v-html="ruleForm.jiaoshifengcai"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='jiaoshirenshu'){
            this.ruleForm.jiaoshirenshu = obj[o];
	    this.ro.jiaoshirenshu = true;
            continue;
          }
          if(o=='fabushijian'){
	    ...
	    this.ro.fabushijian = true;
          ...
          if(o=='jiaoshifengcai'){
            this.ruleForm.jiaoshifengcai = obj[o];
	    this.ro.jiaoshifengcai = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.jiaoshifengcai = this.ruleForm.jiaoshifengcai.replace(reg,'../../../ssm132s8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shizijieshao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shizijieshaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
